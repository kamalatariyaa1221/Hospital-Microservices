package com.hospitalDepartment.Security;

import com.hospitalDepartment.Exception.AuthenticationNotFoundException;
...
//                        SecurityContextHolder.getContext().setAuthentication(authentication);
//                    } else {
//                        response.sendError(HttpServletResponse.SC_UNAUTHORIZED, "Authentication failed.. Try again later");
//                    }
//                }
//
//                filterChain.doFilter(request, response);
